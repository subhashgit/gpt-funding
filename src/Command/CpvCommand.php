...
class CpvCommand extends Command
{
    private $cpv = [
    ...
    public function __construct(
        private readonly CPVCodeRepository $cpvCodeRepository,
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $io->progressStart(count($this->cpv));

        foreach ($this->cpv as $code => $name) {
            $cpvCode = new CPVCode();
            $cpvCode->setCode($code);
            $cpvCode->setDescription($name);
            $this->entityManager->persist($cpvCode);
