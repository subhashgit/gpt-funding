 ...
 */
final class Version20240316221800 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP SEQUENCE revisions_id_seq1 CASCADE');
        $this->addSql('CREATE SEQUENCE request_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->addSql('CREATE TABLE request (id INT NOT NULL, user_id INT NOT NULL, grant_id INT DEFAULT NULL, funding_id INT DEFAULT NULL, status VARCHAR(50) DEFAULT \'new\' NOT NULL, text TEXT DEFAULT NULL, project_overview TEXT DEFAULT NULL, budget_breakdown TEXT DEFAULT NULL, discr VARCHAR(20) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_3B978F9FA76ED395 ON request (user_id)');
        $this->addSql('CREATE INDEX IDX_3B978F9F5C0C89F3 ON request (grant_id)');
        $this->addSql('CREATE INDEX IDX_3B978F9F9D70482 ON request (funding_id)');
        ...
        $this->addSql('ALTER TABLE request ADD CONSTRAINT FK_3B978F9F5C0C89F3 FOREIGN KEY (grant_id) REFERENCES "grant" (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE request ADD CONSTRAINT FK_3B978F9F9D70482 FOREIGN KEY (funding_id) REFERENCES funding (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE SEQUENCE revisions_id_seq1 INCREMENT BY 1 MINVALUE 1 START 1');
        ...
        $this->addSql('ALTER TABLE request DROP CONSTRAINT FK_3B978F9F5C0C89F3');
        $this->addSql('ALTER TABLE request DROP CONSTRAINT FK_3B978F9F9D70482');
